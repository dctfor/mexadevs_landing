...
const translations = {
  en: {
    ...
    'services.team': 'Team Augmentation',
    'services.teamDesc': 'Skilled developers ready to join your existing team',
  ...
  es: {
    ...
    'services.team': 'Ampliación de Equipos',
    'services.teamDesc': 'Desarrolladores calificados listos para unirse a tu equipo existente',
